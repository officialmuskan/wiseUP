...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className='min-h-screen flex flex-col items-start justify-between gap-2 bg-zinc-900 md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <div className='space-y-5'>
        <div className='flex flex-wrap gap-5 items-center'>
          ...
          <div className='flex items-center gap-3 shadow-card border border-cyan-500 p-4 w-56 rounded-md'>
            ...
            <div>
              ...
              <p className='text-base text-gray-300'>Total Enrollment</p>
            </div>
          </div>
          ...
          <div className='flex items-center gap-3 shadow-card border border-cyan-500 p-4 w-56 rounded-md'>
            ...
            <div>
              <p className='text-2xl font-medium text-gray-300'>{currency}{dashboardData.totalEarnings}</p>
        ...
        <div>
          <h2 className='pb-4 text-lg font-medium text-gray-300'>Latest Enrollments</h2>
          <div className='flex flex-col items-center max-w-4xl w-full overflow-hidden rounded-md bg-white border border-gray-500/20'>
          <table className='table-fixed md:table-auto w-full overflow-hidden'>
            <thead className='text-gray-300 bg-zinc-800 border-b border-gray-500/20 text-sm text-left'>
              <tr>
