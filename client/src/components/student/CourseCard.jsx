...
const CourseCard = ({course}) => {
  ...
  return (
    <Link to={`/course/${course._id}`} onClick={() => scrollTo(0,0)} className='flex flex-col gap-2 bg-zinc-800 shadow-md rounded-lg p-4 hover:shadow-lg transition-all duration-300'>
      <img className='w-full' src={course.courseThumbnail} alt="" />
      <div className='p-3 text-left text-gray-400'>
