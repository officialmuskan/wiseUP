...
const myEnrollments = () => {
    ...
    try {
      ...
      const tempProgressArray = await Promise.all(
        enrolledCourses.map( async (course) => {
          const { data } = await axios.post(`/api/user/get-course-progress`, { courseId: course._id }, { headers: { Authorization: `Bearer ${token}` }})
  ...
  return (
    <>
      <div className="md:px-36 px-8 pt-10 text-gray-300">
